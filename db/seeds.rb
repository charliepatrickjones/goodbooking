...
restaurant = Restaurant.new(category: 'Indian', user: User.first, name: 'Helen', address: "Gatehouse Ln, Goddards Green, Hassocks BN6 9LE", rating: 3, phone_number: '0208 12345678', capacity: 20, price_range: 45, description: "BEGIN YOUR DAY AT DISHOOM with breakfast, which might be a Bacon Naan Roll, a Kejriwal or a Big Bombay. Then lunch lightly on Roomali Rolls and Salad Plates, or linger with a feast. Refresh your afternoon with a drop of Chai and a small plate or two. Dine early or dine late. Or just join us for a tipple – perhaps an East India Gimlet, a Viceroy’s Old-fashioned, or our very good Dishoom IPA?", menu: "Bombay breakfast, lunch, afternoon chai, dinner and late tipples. Available for collection and delivery.")
...
restaurant.save
restaurant = Restaurant.new(category: 'Indian', user: User.first, name: 'Edith', address: "Butler's Green Rd, Ha names Heath RH16 4BE", rating: 3, phone_number: '0208 12345678', capacity: 20, price_range: 45, description: "BEGIN YOUR DAY AT DISHOOM with breakfast, which might be a Bacon Naan Roll, a Kejriwal or a Big Bombay. Then lunch lightly on Roomali Rolls and Salad Plates, or linger with a feast. Refresh your afternoon with a drop of Chai and a small plate or two. Dine early or dine late. Or just join us for a tipple – perhaps an East India Gimlet, a Viceroy’s Old-fashioned, or our very good Dishoom IPA?", menu: "Bombay breakfast, lunch, afternoon chai, dinner and late tipples. Available for collection and delivery.")
...
file = URI.open('https://blog.arjo.com/hs-fs/hubfs/Citadel_nurse_reposition.jpg?width=943&name=Citadel_nurse_reposition.jpg')
restaurant.photo.attach(io: file, filename: 'seed-restaurant.jpg', content_type: 'image/jpg')
restaurant.saverestaurant = Restaurant.new(category: 'Chineese', user: User.first, name: 'George', address: "61A Cromwell Ave, Highgate, London N6 5HP", rating: 3, phone_number: '0208 12345678', capacity: 20, price_range: 45, description: "BEGIN YOUR DAY AT DISHOOM with breakfast, which might be a Bacon Naan Roll, a Kejriwal or a Big Bombay. Then lunch lightly on Roomali Rolls and Salad Plates, or linger with a feast. Refresh your afternoon with a drop of Chai and a small plate or two. Dine early or dine late. Or just join us for a tipple – perhaps an East India Gimlet, a Viceroy’s Old-fashioned, or our very good Dishoom IPA?", menu: "Bombay breakfast, lunch, afternoon chai, dinner and late tipples. Available for collection and delivery.")
file = URI.open('https://blog.arjo.com/hs-fs/hubfs/Citadel_nurse_reposition.jpg?width=943&name=Citadel_nurse_reposition.jpg')
restaurant.photo.attach(io: file, filename: 'seed-restaurant.jpg', content_type: 'image/jpg')
restaurant.saverestaurant = Restaurant.new(category: 'Chineese', user: User.first, name: 'George', address: "61A Cromwell Ave, Highgate, London N6 5HP", rating: 3, phone_number: '0208 12345678', capacity: 20, price_range: 45, description: "BEGIN YOUR DAY AT DISHOOM with breakfast, which might be a Bacon Naan Roll, a Kejriwal or a Big Bombay. Then lunch lightly on Roomali Rolls and Salad Plates, or linger with a feast. Refresh your afternoon with a drop of Chai and a small plate or two. Dine early or dine late. Or just join us for a tipple – perhaps an East India Gimlet, a Viceroy’s Old-fashioned, or our very good Dishoom IPA?", menu: "Bombay breakfast, lunch, afternoon chai, dinner and late tipples. Available for collection and delivery.")
file = URI.open('https://blog.arjo.com/hs-fs/hubfs/Citadel_nurse_reposition.jpg?width=943&name=Citadel_nurse_reposition.jpg')
